...
public class MangaSearchQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query MangaSearchQuery($page: Int, $search: String) { Page(page: $page) { __typename media(search: $search, type: MANGA) { __typename id title { __typename romaji english native } coverImage { __typename large } } } }"#
    ))
